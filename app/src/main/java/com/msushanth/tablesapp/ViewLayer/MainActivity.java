package com.msushanth.tablesapp.ViewLayer;
...
import com.msushanth.tablesapp.ControllerLayer.ProfileController;
import com.msushanth.tablesapp.R;
import com.msushanth.tablesapp.Adapters.SectionsPageAdapter;
import com.msushanth.tablesapp.Objects.User;
import com.msushanth.tablesapp.ViewLayer.Account.LogInView;
import com.msushanth.tablesapp.ViewLayer.Account.LogOutView;
import com.msushanth.tablesapp.ViewLayer.Chat.ChatFormXML;
import com.msushanth.tablesapp.ViewLayer.Profile.ProfileViewerForm;
import com.msushanth.tablesapp.ViewLayer.Profile.EditPersonalProfileView;
import com.msushanth.tablesapp.ViewLayer.Search.SearchView;
                ...
                if(item.toString().equals("My Account")) {
                    dbReference.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Intent selectMatchedUsersIntent = new Intent(MainActivity.this, ProfileViewerForm.class);
