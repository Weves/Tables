package com.msushanth.tablesapp.ViewLayer.Profile;
...
public class ProfileViewerForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog progressDialog = ProgressDialog.show(ProfileViewerForm.this, "Please wait...", "Processing", true);
